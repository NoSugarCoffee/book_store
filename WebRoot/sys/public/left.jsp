	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath}/bookServlet?method=listAll&currentPage=1">图书管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/typeServlet?method=list">类别管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/orderServlet?method=getOrder_sys">订单信息</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/accountServlet?method=getAccountsByPageList">账户管理</a>
				</li>
            </ul>
        </li>
    </ul>
